...
def reconstruct_and_export(image, image_name):
    ...
    loop_out_path = f"{image_name}.mp4"
    imageio.mimsave(loop_out_path, loop_renders, fps=25)
    ply_out_path = f"{image_name}_mesh.ply"
...
if __name__ == '__main__':
    ...
    image = Image.open("/home/cap6411.student1/CVsystem/final_project/image_fusion/test_img/front_XL-image-NoBG0.jpg")
